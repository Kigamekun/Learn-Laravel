                                ...
                                <tbody>
                                    @foreach (DB::table('users')->get() as $item)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <button type="button" data-url="{{ route('pegawai.update',['id'=>$item->id]) }}" data-name="{{$item->name}}" data-email="{{$item->email}}" data-bs-toggle="modal" data-bs-target="#updateModal" class="btn btn-sm btn-square btn-neutral text-danger-hover">
                                                U
                                            </button>
                                                <form action="{{ route('pegawai.delete', ['id' => $item->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
    ...
    <div class="modal-header">
                ...
                <form action="${$(e.relatedTarget).data('url')}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Username</label>
                            <input type="text" name="name" value="${$(e.relatedTarget).data('name')}" class="form-control" id="exampleFormControlInput1"
                                placeholder="name@example.com">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Email address</label>
                            <input type="email" name="email" value="${$(e.relatedTarget).data('email')}" class="form-control" id="exampleFormControlInput1"
                                placeholder="name@example.com">
                        </div>
